...
export default function Home()
{
    ...
    let [latestreleases,setLatest]=useState([])
    ...
    useEffect(async ()=>{
        ...
        try 
        {
            ...
            // filter for latest releases movies 
            let lat = moviesData.filter((movie)=>{return movie.latest===true})
            setLatest(lat.slice(0,6))
    ...
    return (
        <>
            ...
            <Shows title="Latest Releases" movies={latestreleases}/>
